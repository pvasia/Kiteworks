...
import styles from "./IconFourTiles.module.scss";
import classNames from "classnames";
import IconHeading, {
  IconHeadingProps,
} from "@/components/molecules/IconHeading";

export interface IconFourTilesProps {
  items: IconHeadingProps[];
  title?: string;
  subHeading?: string;
}

const IconFourTiles = ({ items, title, subHeading }: IconFourTilesProps) => {
  console.log("items", items);
  return (
    <div className={styles.iconFourTiles}>
