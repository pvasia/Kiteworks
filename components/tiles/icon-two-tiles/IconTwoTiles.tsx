...
import styles from "./IconTwoTiles.module.scss";
import classNames from "classnames";
import IconHeading, {
  IconHeadingProps,
} from "@/components/molecules/IconHeading";

export interface IconTwoTilesProps {
  items: IconHeadingProps[];
  title?: string;
  subHeading?: string;
}

const IconTwoTiles = ({ items, title, subHeading }: IconTwoTilesProps) => {
  console.log("items", items);
  return (
    <div className={styles.iconTwoTiles}>
